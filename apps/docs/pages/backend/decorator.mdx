...
```ts
import { User, type SysLoginUser, type SysUser } from '@/modules/core';
...
```ts
import { UserId } from '@/modules/core';
...
```ts
import { UserName } from '@/modules/core';
...
```ts
import { RepeatSubmit } from '@/modules/core';
