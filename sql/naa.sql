...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, NULL, 'admin', '管理员', '00', 'admin@vivy.com', '18688888888', '0', '/uploads/avatar/admin.png', '$2b$10$Ls.NOGe4NoJeqPyndmZuouXQMAql3r4HaMnqDGn0lKdEbrPwpIKpe', '0', 'admin', sysdate(), 'admin', sysdate());
